...
def parse():
    ...
    parser.add_argument('--root_dir', type=str,
                        default=r'C:\Users\Vanshi\Desktop\denoising\Image-Denoising-with-Deep-CNNs-master\BSDS300\images', help='root directory of dataset')
...
class Args():
    ...
    def __init__(self):
        self.root_dir = r'C:\Users\Vanshi\Desktop\denoising\Image-Denoising-with-Deep-CNNs-master\BSDS300\images'
        self.output_dir = r'C:\Users\Vanshi\Desktop\denoising\Image-Denoising-with-Deep-CNNs-master\checkpoints'
        self.num_epochs = 200
        self.D = 6
        self.C = 64
        self.plot = False
